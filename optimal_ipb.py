...
class OptimalIpbPlugin(object):
    ...
    def initGui(self):
        ...
        self.iface.addPluginToMenu(u"&Optimal-IPB", self.action)
        self.iface.addToolBarIcon(self.action)

    def unload(self):
        QgsApplication.processingRegistry().removeProvider(self.provider)
        self.iface.removePluginMenu(u"&Optimal-IPB", self.action)
        self.iface.removeToolBarIcon(self.action)
    
    def run(self):
        processing.execAlgorithmDialog("OPTIMAL-IPB:OPTIMAL-IPB")
